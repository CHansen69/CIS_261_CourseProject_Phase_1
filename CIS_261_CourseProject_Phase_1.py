...
def printinfo(empname, hours, hourlyrate,grosspay, taxrate, incometax, netpay):
    ...
    print("Enter hourly rate: ", f"{hourlyrate:,.2f}")
    print("Enter gross pay: ", f"{grosspay:,.2f}")
    # taxrate needs to be formatted as percentage
    print("Enter tax rate: ", f"{taxrate:,.1%}")
    print("Enter income tax: ", f"{incometax:,.2f}")
    print("Enter net pay: ", f"{netpay:,.2f}")
